		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "VSCodeDeplTest",
									"targetURL": "#VSCodeDeplTest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"VSCodeDeplTest-display": {
								"semanticObject": "VSCodeDeplTest",
								"action": "display",
								"description": "-",
								"title": "VSCodeDeplTest",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=teamidea.test.VSCodeDeplTest",
									"url": sap.ui.require.toUrl("teamidea/test/VSCodeDeplTest")
								}
							}
						}
					}
